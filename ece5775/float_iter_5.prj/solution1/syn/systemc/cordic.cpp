...
void cordic::thread_exitcond_fu_195_p2() {
    exitcond_fu_195_p2 = (!step_reg_129.read().is_01() || !ap_const_lv3_5.is_01())? sc_lv<1>(): sc_lv<1>(step_reg_129.read() == ap_const_lv3_5);
}
...
void cordic::thread_grp_fu_152_p0() {
    grp_fu_152_p0 = esl_zext<32,5>(tmp_2_fu_211_p2.read());
}
...
void cordic::thread_step_1_fu_201_p2() {
    step_1_fu_201_p2 = (!step_reg_129.read().is_01() || !ap_const_lv3_1.is_01())? sc_lv<3>(): (sc_bigint<3>(step_reg_129.read()) + sc_biguint<3>(ap_const_lv3_1));
}

void cordic::thread_tmp_1_cast_fu_207_p1() {
    tmp_1_cast_fu_207_p1 = esl_zext<5,3>(step_reg_129.read());
}

void cordic::thread_tmp_1_fu_226_p1() {
    tmp_1_fu_226_p1 = esl_zext<64,3>(step_reg_129.read());
}

void cordic::thread_tmp_2_fu_211_p2() {
    tmp_2_fu_211_p2 = (!tmp_1_cast_fu_207_p1.read().is_01())? sc_lv<5>(): ap_const_lv5_1 << (unsigned short)tmp_1_cast_fu_207_p1.read().to_uint();
}
