; ModuleID = '/home/student/gsf52/ece5775/float_iter_5.prj/solution1/.autopilot/db/a.o.3.bc'
...
.backedge:                                        ; preds = %3, %2, %0
  ...
  %step = phi i3 [ 0, %0 ], [ %step_1, %3 ], [ %step_1, %2 ] ; [#uses=4 type=i3]
  ...
  %exitcond = icmp eq i3 %step, -3, !dbg !37      ; [#uses=1 type=i1] [debug line = 60:8]
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 5, i64 5, i64 5) nounwind ; [#uses=0 type=i32]
  %step_1 = add i3 %step, 1, !dbg !40             ; [#uses=2 type=i3] [debug line = 60:22]
  call void @llvm.dbg.value(metadata !{i3 %step_1}, i64 0, metadata !41), !dbg !40 ; [debug line = 60:22] [debug variable = step]
...
; <label>:1                                       ; preds = %.backedge
  ...
  %tmp_1 = zext i3 %step to i64, !dbg !47         ; [#uses=2 type=i64] [debug line = 62:5]
  %tmp_1_cast = zext i3 %step to i5, !dbg !47     ; [#uses=1 type=i5] [debug line = 62:5]
  %tmp_2 = shl i5 1, %tmp_1_cast, !dbg !47        ; [#uses=1 type=i5] [debug line = 62:5]
  %tmp_s = zext i5 %tmp_2 to i32, !dbg !47        ; [#uses=1 type=i32] [debug line = 62:5]
...
!40 = metadata !{i32 60, i32 22, metadata !38, null}
...
!45 = metadata !{i32 786443, metadata !38, i32 60, i32 29, metadata !23, i32 2} ; [ DW_TAG_lexical_block ]
