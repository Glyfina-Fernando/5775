; ModuleID = '/home/student/gsf52/ece5775/float_iter_5.prj/solution1/.autopilot/db/a.o.2.bc'
...
.backedge:                                        ; preds = %2, %3, %0
  ...
  %step = phi i3 [ 0, %0 ], [ %step_1, %3 ], [ %step_1, %2 ]
...
; <label>:1                                       ; preds = %.backedge
  ...
  %tmp_1 = zext i3 %step to i64
  %tmp_1_cast = zext i3 %step to i5
  %tmp_2 = shl i5 1, %tmp_1_cast
  %tmp_s = zext i5 %tmp_2 to i32
