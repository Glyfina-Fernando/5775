...
_ifconv:                                          ; preds = %1
  ...
  %tmp_s = call i24 @_ssdm_op_BitConcatenate.i24.i12.i12(i12 %p_Val2_6, i12 0)
  %tmp_cast = zext i24 %tmp_s to i32
...
define weak i24 @_ssdm_op_BitConcatenate.i24.i12.i12(i12, i12) nounwind readnone {
entry:
  %empty = zext i12 %0 to i24
  %empty_8 = zext i12 %1 to i24
  %empty_9 = trunc i24 %empty to i12
  %empty_10 = call i12 @_ssdm_op_PartSelect.i12.i24.i32.i32(i24 %empty_8, i32 12, i32 23)
  %empty_11 = or i12 %empty_9, %empty_10
  %empty_12 = call i24 @_ssdm_op_PartSet.i24.i24.i12.i32.i32(i24 %empty_8, i12 %empty_11, i32 12, i32 23)
  ret i24 %empty_12
}
...
define weak i12 @_ssdm_op_PartSelect.i12.i24.i32.i32(i24, i32, i32) nounwind readnone {
entry:
  %empty = call i24 @llvm.part.select.i24(i24 %0, i32 %1, i32 %2)
  %empty_13 = trunc i24 %empty to i12
  ret i12 %empty_13
}

define weak i24 @_ssdm_op_PartSet.i24.i24.i12.i32.i32(i24, i12, i32, i32) nounwind readnone {
entry:
  %empty = call i24 @llvm.part.set.i24.i12(i24 %0, i12 %1, i32 %2, i32 %3)
  ret i24 %empty
}

declare i24 @llvm.part.select.i24(i24, i32, i32) nounwind readnone

declare i24 @llvm.part.set.i24.i12(i24, i12, i32, i32) nounwind readnone
