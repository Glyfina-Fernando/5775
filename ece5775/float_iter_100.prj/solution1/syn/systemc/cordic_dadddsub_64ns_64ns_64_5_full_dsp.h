...
#ifndef __cordic_dadddsub_64ns_64ns_64_5_full_dsp__HH__
#define __cordic_dadddsub_64ns_64ns_64_5_full_dsp__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cordic_dadddsub_64ns_64ns_64_5_full_dsp) {
    ...
    SC_CTOR(cordic_dadddsub_64ns_64ns_64_5_full_dsp):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
