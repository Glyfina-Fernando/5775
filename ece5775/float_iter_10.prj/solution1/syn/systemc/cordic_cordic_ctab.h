...
#ifndef __cordic_cordic_ctab_H__
#define __cordic_cordic_ctab_H__
...
struct cordic_cordic_ctab_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(cordic_cordic_ctab_ram) {
...
cordic_cordic_ctab_ram* meminst;


SC_CTOR(cordic_cordic_ctab) {
meminst = new cordic_cordic_ctab_ram("cordic_cordic_ctab_ram");
