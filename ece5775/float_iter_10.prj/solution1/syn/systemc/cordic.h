...
struct cordic : public sc_module {
    ...
    sc_signal< sc_lv<4> > step_1_fu_201_p2;
    sc_signal< sc_lv<4> > step_1_reg_258;
    ...
    sc_signal< sc_lv<4> > step_reg_129;
    ...
    sc_signal< sc_lv<10> > tmp_1_cast_fu_207_p1;
    sc_signal< sc_lv<10> > tmp_2_fu_211_p2;
