...
architecture behav of cordic is 
    ...
    "cordic,hls_ip_2014_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.593000,HLS_SYN_LAT=422,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=0,HLS_SYN_LUT=0}";
    ...
    signal tmp_1_cast_fu_207_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_2_fu_211_p2 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    exitcond_fu_195_p2 <= "1" when (step_reg_129 = ap_const_lv4_A) else "0";
    ...
    tmp_1_cast_fu_207_p1 <= std_logic_vector(resize(unsigned(step_reg_129),10));
    tmp_1_fu_226_p1 <= std_logic_vector(resize(unsigned(step_reg_129),64));
    tmp_2_fu_211_p2 <= std_logic_vector(shift_left(unsigned(ap_const_lv10_1),to_integer(unsigned('0' & tmp_1_cast_fu_207_p1(10-1 downto 0)))));
end behav;
