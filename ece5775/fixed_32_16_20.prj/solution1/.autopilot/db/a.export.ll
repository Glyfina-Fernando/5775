; ModuleID = '/home/student/gsf52/ece5775/fixed_32_16_20.prj/solution1/.autopilot/db/a.o.2.bc'
...
@angles_V = internal unnamed_addr constant [20 x i16] [i16 -14065, i16 30385, i16 16054, i16 8149, i16 4090, i16 2047, i16 1023, i16 511, i16 255, i16 127, i16 63, i16 31, i16 15, i16 7, i16 3, i16 1, i16 0, i16 0, i16 0, i16 0]
...
; <label>:0                                       ; preds = %_ifconv, %codeRepl
  ...
  %p_Val2_s = phi i32 [ 39796, %codeRepl ], [ %X_V_2, %_ifconv ]
...
_ifconv:                                          ; preds = %0
  ...
  %angles_V_addr = getelementptr [20 x i16]* @angles_V, i64 0, i64 %tmp_6
  %p_Val2_5 = load i16* %angles_V_addr, align 2
  %p_Val2_5_cast = zext i16 %p_Val2_5 to i32
