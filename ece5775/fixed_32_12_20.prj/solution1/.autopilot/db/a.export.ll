; ModuleID = '/home/student/gsf52/ece5775/fixed_32_12_20.prj/solution1/.autopilot/db/a.o.2.bc'
...
@angles_V = internal unnamed_addr constant [20 x i20] [i20 -225027, i20 486169, i20 256878, i20 130395, i20 65450, i20 32757, i20 16382, i20 8191, i20 4095, i20 2047, i20 1023, i20 511, i20 255, i20 127, i20 63, i20 31, i20 15, i20 7, i20 4, i20 1]
...
; <label>:0                                       ; preds = %_ifconv, %codeRepl
  ...
  %p_Val2_s = phi i32 [ 636750, %codeRepl ], [ %X_V_2, %_ifconv ]
...
_ifconv:                                          ; preds = %0
  ...
  %angles_V_addr = getelementptr [20 x i20]* @angles_V, i64 0, i64 %tmp_6
  %p_Val2_5 = load i20* %angles_V_addr, align 4
  %p_Val2_5_cast = zext i20 %p_Val2_5 to i32
