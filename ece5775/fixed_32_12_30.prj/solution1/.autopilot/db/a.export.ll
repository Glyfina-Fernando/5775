...
; <label>:1                                       ; preds = %_ifconv, %0
  ...
  %p_Val2_s = phi i32 [ 1583349760, %0 ], [ %X_V_2, %_ifconv ]
...
_ifconv:                                          ; preds = %1
  ...
  %tmp_s = call i32 @_ssdm_op_BitConcatenate.i32.i12.i20(i12 %p_Val2_6, i20 0)
  %p_Val2_8 = add i32 %tmp_s, %p_Val2_4
  %T_V_1 = add i32 %p_Val2_1, %p_Val2_s
  %p_Val2_s_7 = sub i32 0, %p_Val2_2
  %p_Val2_5 = sub i32 %p_Val2_4, %tmp_s
...
entry:
  %empty = zext i12 %0 to i32
  %empty_8 = zext i20 %1 to i32
  %empty_9 = trunc i32 %empty to i12
  %empty_10 = call i12 @_ssdm_op_PartSelect.i12.i32.i32.i32(i32 %empty_8, i32 20, i32 31)
  %empty_11 = or i12 %empty_9, %empty_10
  %empty_12 = call i32 @_ssdm_op_PartSet.i32.i32.i12.i32.i32(i32 %empty_8, i12 %empty_11, i32 20, i32 31)
  ret i32 %empty_12
}
