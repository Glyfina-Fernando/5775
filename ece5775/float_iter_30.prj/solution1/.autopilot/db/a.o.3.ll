; ModuleID = '/home/student/gsf52/ece5775/float_iter_30.prj/solution1/.autopilot/db/a.o.3.bc'
...
.backedge:                                        ; preds = %3, %2, %0
  ...
  %exitcond = icmp eq i5 %step, -2, !dbg !37      ; [#uses=1 type=i1] [debug line = 60:8]
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 30, i64 30, i64 30) nounwind ; [#uses=0 type=i32]
...
; <label>:1                                       ; preds = %.backedge
  ...
  %tmp_1_cast = zext i5 %step to i30, !dbg !47    ; [#uses=1 type=i30] [debug line = 62:5]
  %tmp_2 = shl i30 1, %tmp_1_cast, !dbg !47       ; [#uses=1 type=i30] [debug line = 62:5]
  %tmp_s = zext i30 %tmp_2 to i32, !dbg !47       ; [#uses=1 type=i32] [debug line = 62:5]
