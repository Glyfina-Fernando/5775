; ModuleID = '/home/student/gsf52/ece5775/float_iter_30.prj/solution1/.autopilot/db/a.o.2.bc'
...
.backedge:                                        ; preds = %2, %3, %0
  ...
  %exitcond = icmp eq i5 %step, -2
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 30, i64 30, i64 30) nounwind
...
; <label>:1                                       ; preds = %.backedge
  ...
  %tmp_1_cast = zext i5 %step to i30
  %tmp_2 = shl i30 1, %tmp_1_cast
