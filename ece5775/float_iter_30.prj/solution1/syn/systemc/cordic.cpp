...
const sc_lv<30> cordic::ap_const_lv30_1 = "1";
...
void cordic::thread_exitcond_fu_195_p2() {
    exitcond_fu_195_p2 = (!step_reg_129.read().is_01() || !ap_const_lv5_1E.is_01())? sc_lv<1>(): sc_lv<1>(step_reg_129.read() == ap_const_lv5_1E);
}
...
void cordic::thread_grp_fu_152_p0() {
    grp_fu_152_p0 = esl_zext<32,30>(tmp_2_fu_211_p2.read());
}
...
void cordic::thread_tmp_1_cast_fu_207_p1() {
    tmp_1_cast_fu_207_p1 = esl_zext<30,5>(step_reg_129.read());
}
...
void cordic::thread_tmp_2_fu_211_p2() {
    tmp_2_fu_211_p2 = (!tmp_1_cast_fu_207_p1.read().is_01())? sc_lv<30>(): ap_const_lv30_1 << (unsigned short)tmp_1_cast_fu_207_p1.read().to_uint();
}
