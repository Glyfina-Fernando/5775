...
(* CORE_GENERATION_INFO="cordic,hls_ip_2014_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.593000,HLS_SYN_LAT=632,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=0,HLS_SYN_LUT=0}" *)
...
reg   [31:0] reg_169;
reg   [31:0] reg_175;
wire   [3:0] step_1_fu_201_p2;
reg   [3:0] step_1_reg_258;
...
wire   [14:0] tmp_1_cast_fu_207_p1;
wire   [14:0] tmp_2_fu_211_p2;
...
assign exitcond_fu_195_p2 = (step_reg_129 == ap_const_lv4_F? 1'b1: 1'b0);
...
assign s = Y_fu_46;
assign step_1_fu_201_p2 = (step_reg_129 + ap_const_lv4_1);
assign tmp_1_cast_fu_207_p1 = $unsigned(step_reg_129);
assign tmp_1_fu_226_p1 = $unsigned(step_reg_129);
assign tmp_2_fu_211_p2 = ap_const_lv15_1 << tmp_1_cast_fu_207_p1;
