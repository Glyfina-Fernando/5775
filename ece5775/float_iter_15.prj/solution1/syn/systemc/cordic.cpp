...
const sc_lv<4> cordic::ap_const_lv4_F = "1111";
const sc_lv<4> cordic::ap_const_lv4_1 = "1";
const sc_lv<15> cordic::ap_const_lv15_1 = "1";
...
void cordic::thread_exitcond_fu_195_p2() {
    exitcond_fu_195_p2 = (!step_reg_129.read().is_01() || !ap_const_lv4_F.is_01())? sc_lv<1>(): sc_lv<1>(step_reg_129.read() == ap_const_lv4_F);
}
...
void cordic::thread_grp_fu_152_p0() {
    grp_fu_152_p0 = esl_zext<32,15>(tmp_2_fu_211_p2.read());
}
...
void cordic::thread_step_1_fu_201_p2() {
    step_1_fu_201_p2 = (!step_reg_129.read().is_01() || !ap_const_lv4_1.is_01())? sc_lv<4>(): (sc_bigint<4>(step_reg_129.read()) + sc_biguint<4>(ap_const_lv4_1));
}

void cordic::thread_tmp_1_cast_fu_207_p1() {
    tmp_1_cast_fu_207_p1 = esl_zext<15,4>(step_reg_129.read());
}

void cordic::thread_tmp_1_fu_226_p1() {
    tmp_1_fu_226_p1 = esl_zext<64,4>(step_reg_129.read());
}

void cordic::thread_tmp_2_fu_211_p2() {
    tmp_2_fu_211_p2 = (!tmp_1_cast_fu_207_p1.read().is_01())? sc_lv<15>(): ap_const_lv15_1 << (unsigned short)tmp_1_cast_fu_207_p1.read().to_uint();
}
