; ModuleID = '/home/student/gsf52/ece5775/float_iter_15.prj/solution1/.autopilot/db/a.o.3.bc'
...
.backedge:                                        ; preds = %3, %2, %0
  ...
  %exitcond = icmp eq i4 %step, -1, !dbg !37      ; [#uses=1 type=i1] [debug line = 60:8]
...
; <label>:1                                       ; preds = %.backedge
  ...
  %tmp_1_cast = zext i4 %step to i15, !dbg !47    ; [#uses=1 type=i15] [debug line = 62:5]
  %tmp_2 = shl i15 1, %tmp_1_cast, !dbg !47       ; [#uses=1 type=i15] [debug line = 62:5]
  %tmp_s = zext i15 %tmp_2 to i32, !dbg !47       ; [#uses=1 type=i32] [debug line = 62:5]
