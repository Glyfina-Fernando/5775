...
set C_modelArgList { 
	...
	{ s float 32 regular {pointer 1}  }
	{ c float 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "theta", "interface" : "wire", "bitwidth" : 32,"bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "theta","cData": "float","cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	{ "Name" : "s", "interface" : "wire", "bitwidth" : 32,"bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "s","cData": "float","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "c", "interface" : "wire", "bitwidth" : 32,"bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "c","cData": "float","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} ]}
