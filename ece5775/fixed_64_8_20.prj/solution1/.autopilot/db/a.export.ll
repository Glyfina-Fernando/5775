; ModuleID = '/home/student/gsf52/ece5775/fixed_64_8_20.prj/solution1/.autopilot/db/a.o.2.bc'
...
; <label>:0                                       ; preds = %_ifconv, %codeRepl
  ...
  %p_Val2_s = phi i64 [ 43757185475999376, %codeRepl ], [ %X_V_2, %_ifconv ]
...
_ifconv:                                          ; preds = %0
  ...
  %angles_V_addr = getelementptr [20 x i56]* @angles_V, i64 0, i64 %tmp_3
  %p_Val2_5 = load i56* %angles_V_addr, align 8
  %p_Val2_5_cast = zext i56 %p_Val2_5 to i64
