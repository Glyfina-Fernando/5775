...
const sc_lv<32> cordic::ap_const_lv32_5E60 = "101111001100000";
...
cordic::cordic(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_Y_V_fu_219_p2);
    sensitive << ( p_Val2_3_reg_82 );
    sensitive << ( p_Val2_3_pn_fu_206_p3 );
    ...
    SC_METHOD(thread_current_V_fu_212_p3);
    sensitive << ( tmp_2_reg_238 );
    sensitive << ( p_Val2_8_fu_189_p2 );
    sensitive << ( p_Val2_5_fu_200_p2 );
    ...
    SC_METHOD(thread_p_Val2_3_pn_fu_206_p3);
    sensitive << ( tmp_2_reg_238 );
    sensitive << ( p_Val2_2_reg_244 );
    sensitive << ( p_Val2_s_7_fu_195_p2 );

    SC_METHOD(thread_p_Val2_5_fu_200_p2);
    sensitive << ( p_Val2_4_reg_70 );
    sensitive << ( tmp_cast_fu_185_p1 );

    SC_METHOD(thread_p_Val2_8_fu_189_p2);
    sensitive << ( p_Val2_4_reg_70 );
    sensitive << ( tmp_cast_fu_185_p1 );

    SC_METHOD(thread_p_Val2_s_7_fu_195_p2);
    sensitive << ( p_Val2_2_reg_244 );
    ...
    sc_trace(mVcdFile, step_reg_233, "step_reg_233");
    ...
    sc_trace(mVcdFile, X_V_2_reg_255, "X_V_2_reg_255");
    sc_trace(mVcdFile, current_V_fu_212_p3, "current_V_fu_212_p3");
    sc_trace(mVcdFile, Y_V_fu_219_p2, "Y_V_fu_219_p2");
    ...
    sc_trace(mVcdFile, p_Val2_s_7_fu_195_p2, "p_Val2_s_7_fu_195_p2");
    sc_trace(mVcdFile, p_Val2_8_fu_189_p2, "p_Val2_8_fu_189_p2");
    sc_trace(mVcdFile, p_Val2_5_fu_200_p2, "p_Val2_5_fu_200_p2");
    sc_trace(mVcdFile, p_Val2_3_pn_fu_206_p3, "p_Val2_3_pn_fu_206_p3");
...
void cordic::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,2,2>(ap_ST_st3_fsm_2, ap_CS_fsm.read())) {
        p_Val2_3_reg_82 = Y_V_fu_219_p2.read();
    } else if ((esl_seteq<1,2,2>(ap_ST_st1_fsm_0, ap_CS_fsm.read()) && 
                !esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0))) {
        p_Val2_3_reg_82 = ap_const_lv32_0;
    }
    if (esl_seteq<1,2,2>(ap_ST_st3_fsm_2, ap_CS_fsm.read())) {
        p_Val2_4_reg_70 = current_V_fu_212_p3.read();
    } else if ((esl_seteq<1,2,2>(ap_ST_st1_fsm_0, ap_CS_fsm.read()) && 
                !esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0))) {
        p_Val2_4_reg_70 = ap_const_lv32_0;
    }
    if (esl_seteq<1,2,2>(ap_ST_st3_fsm_2, ap_CS_fsm.read())) {
        p_Val2_s_reg_95 = X_V_2_reg_255.read();
    } else if ((esl_seteq<1,2,2>(ap_ST_st1_fsm_0, ap_CS_fsm.read()) && 
                !esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0))) {
        p_Val2_s_reg_95 = ap_const_lv32_5E60;
    }
    if (esl_seteq<1,2,2>(ap_ST_st3_fsm_2, ap_CS_fsm.read())) {
        sh_assign_reg_107 = step_reg_233.read();
    } else if ((esl_seteq<1,2,2>(ap_ST_st1_fsm_0, ap_CS_fsm.read()) && 
                !esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0))) {
    ...
    if ((esl_seteq<1,2,2>(ap_ST_st2_fsm_1, ap_CS_fsm.read()) && esl_seteq<1,1,1>(exitcond_fu_123_p2.read(), ap_const_lv1_0))) {
        X_V_2_reg_255 = X_V_2_fu_169_p3.read();
        p_Val2_2_reg_244 = p_Val2_2_fu_152_p2.read();
        tmp_2_reg_238 = tmp_2_fu_135_p2.read();
    }
    if (esl_seteq<1,2,2>(ap_ST_st2_fsm_1, ap_CS_fsm.read())) {
        step_reg_233 = step_fu_129_p2.read();
    }
}
...
void cordic::thread_Y_V_fu_219_p2() {
    Y_V_fu_219_p2 = (!p_Val2_3_pn_fu_206_p3.read().is_01() || !p_Val2_3_reg_82.read().is_01())? sc_lv<32>(): (sc_bigint<32>(p_Val2_3_pn_fu_206_p3.read()) + sc_biguint<32>(p_Val2_3_reg_82.read()));
}
...
void cordic::thread_current_V_fu_212_p3() {
    current_V_fu_212_p3 = (!tmp_2_reg_238.read()[0].is_01())? sc_lv<32>(): ((tmp_2_reg_238.read()[0].to_bool())? p_Val2_8_fu_189_p2.read(): p_Val2_5_fu_200_p2.read());
}

void cordic::thread_exitcond_fu_123_p2() {
    exitcond_fu_123_p2 = (!sh_assign_reg_107.read().is_01() || !ap_const_lv5_14.is_01())? sc_lv<1>(): sc_lv<1>(sh_assign_reg_107.read() == ap_const_lv5_14);
}
...
void cordic::thread_p_Val2_3_pn_fu_206_p3() {
    p_Val2_3_pn_fu_206_p3 = (!tmp_2_reg_238.read()[0].is_01())? sc_lv<32>(): ((tmp_2_reg_238.read()[0].to_bool())? p_Val2_2_reg_244.read(): p_Val2_s_7_fu_195_p2.read());
}

void cordic::thread_p_Val2_5_fu_200_p2() {
    p_Val2_5_fu_200_p2 = (!p_Val2_4_reg_70.read().is_01() || !tmp_cast_fu_185_p1.read().is_01())? sc_lv<32>(): (sc_bigint<32>(p_Val2_4_reg_70.read()) - sc_biguint<32>(tmp_cast_fu_185_p1.read()));
}

void cordic::thread_p_Val2_8_fu_189_p2() {
    p_Val2_8_fu_189_p2 = (!tmp_cast_fu_185_p1.read().is_01() || !p_Val2_4_reg_70.read().is_01())? sc_lv<32>(): (sc_bigint<32>(tmp_cast_fu_185_p1.read()) + sc_biguint<32>(p_Val2_4_reg_70.read()));
}

void cordic::thread_p_Val2_s_7_fu_195_p2() {
    p_Val2_s_7_fu_195_p2 = (!ap_const_lv32_0.is_01() || !p_Val2_2_reg_244.read().is_01())? sc_lv<32>(): (sc_bigint<32>(ap_const_lv32_0) - sc_biguint<32>(p_Val2_2_reg_244.read()));
}
...
void cordic::thread_tmp_cast_fu_185_p1() {
    tmp_cast_fu_185_p1 = esl_zext<32,16>(tmp_s_fu_177_p3.read());
}

void cordic::thread_tmp_s_fu_177_p3() {
    tmp_s_fu_177_p3 = esl_concat<12,4>(angles_q0.read(), ap_const_lv4_0);
}
