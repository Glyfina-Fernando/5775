; ModuleID = '/home/student/gsf52/ece5775/fixed_32_28_20.prj/solution1/.autopilot/db/a.o.2.bc'
...
; <label>:1                                       ; preds = %_ifconv, %0
  ...
  %p_Val2_s = phi i32 [ 24160, %0 ], [ %X_V_2, %_ifconv ]
...
_ifconv:                                          ; preds = %1
  ...
  %tmp_s = call i16 @_ssdm_op_BitConcatenate.i16.i12.i4(i12 %p_Val2_6, i4 0)
  %tmp_cast = zext i16 %tmp_s to i32
...
entry:
  %empty = zext i12 %0 to i16
  %empty_8 = zext i4 %1 to i16
  %empty_9 = trunc i16 %empty to i12
  %empty_10 = call i12 @_ssdm_op_PartSelect.i12.i16.i32.i32(i16 %empty_8, i32 4, i32 15)
  %empty_11 = or i12 %empty_9, %empty_10
  %empty_12 = call i16 @_ssdm_op_PartSet.i16.i16.i12.i32.i32(i16 %empty_8, i12 %empty_11, i32 4, i32 15)
  ret i16 %empty_12
}
...
entry:
  ...
  %empty_13 = trunc i16 %empty to i12
  ret i12 %empty_13
}

define weak i16 @_ssdm_op_PartSet.i16.i16.i12.i32.i32(i16, i12, i32, i32) nounwind readnone {
entry:
  %empty = call i16 @llvm.part.set.i16.i12(i16 %0, i12 %1, i32 %2, i32 %3)
  ret i16 %empty
}
