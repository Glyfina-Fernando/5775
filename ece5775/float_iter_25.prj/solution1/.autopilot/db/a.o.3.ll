; ModuleID = '/home/student/gsf52/ece5775/float_iter_25.prj/solution1/.autopilot/db/a.o.3.bc'
...
.backedge:                                        ; preds = %3, %2, %0
  ...
  %exitcond = icmp eq i5 %step, -7, !dbg !37      ; [#uses=1 type=i1] [debug line = 60:8]
...
; <label>:1                                       ; preds = %.backedge
  ...
  %tmp_1_cast = zext i5 %step to i25, !dbg !47    ; [#uses=1 type=i25] [debug line = 62:5]
  %tmp_2 = shl i25 1, %tmp_1_cast, !dbg !47       ; [#uses=1 type=i25] [debug line = 62:5]
  %tmp_s = zext i25 %tmp_2 to i32, !dbg !47       ; [#uses=1 type=i32] [debug line = 62:5]
