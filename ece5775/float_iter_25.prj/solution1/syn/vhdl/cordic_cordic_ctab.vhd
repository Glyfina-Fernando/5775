...
entity cordic_cordic_ctab_rom is 
    generic(
             dwidth     : integer := 32; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of cordic_cordic_ctab_rom is 
...
architecture arch of cordic_cordic_ctab is
    component cordic_cordic_ctab_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    cordic_cordic_ctab_rom_U :  component cordic_cordic_ctab_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
